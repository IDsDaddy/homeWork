					...
					<div class="leftbody">
						...
						<section id = "itemMain">
							...
							<?php
								...
								$sthItem = $dbh->prepare("SELECT * FROM publications WHERE id=$itemID");
								
								$sthItem->execute();
								
								$pubItem = $sthItem->fetch(PDO::FETCH_ASSOC);
								
								$pubItemTitle = $pubItem["title"];
								$pubItemAuthor = $pubItem["author"];
								$pubItempubDate = $pubItem["pubDate"];
								$pubPublisher = $pubItem["publisher"];
								
								
							?>
							<p id="itemTitle"><?php echo $pubItemTitle;?></p>
                            <p id="pubPublisher">Publisher: <?php echo $pubPublisher;?>&nbsp;&nbsp;&nbsp;<?php echo $pubItempubDate;?></p>
                            
							<p id="itemAuthor">Author: <?php echo $pubItemAuthor;?></p>
							...
							<div id="itemBody">
								...
								<?php					
									...
									$sthItemAllImages = $dbh->prepare("SELECT imageURL FROM imagelib WHERE pubId = $itemID");
								...
								?>
                                        ...
                                        $(document).ready(function()
                                        {
                                            ...
                                            $(".itemImageTile").mouseenter(function()
                                            {
						...
						<ul class = "listContain">
						 ...
						 <?php 
							  ...
							  foreach($recentNews as $content)
							  {
								  ...
								  echo 
								  '<li class="listLink"><a href="pubitem.php?id='.$content["id"].'">
